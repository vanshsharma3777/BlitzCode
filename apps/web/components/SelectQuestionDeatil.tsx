...
<div className="min-h-screen flex items-center justify-center bg-[#0B1120] px-4">
    <form onSubmit={handleSubmit} className="w-full max-w-lg rounded-2xl bg-[#111827] shadow-2xl p-8 space-y-6">
        <h1 className="text-2xl font-bold text-gray-100 text-center">Practice Setup</h1>
